					...
					<nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
					  ...
					  <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
						...
						<li class="has-children">
						  <a href="{{route('home.movies')}}">Gallary</a>
						  <ul class="dropdown">
							
							<li><a href="{{route('home.gallary', 'nature')}}">Movies</a></li>
							<li><a href="{{route('home.gallary', 'portrait')}}">Softwares</a></li>
							<li><a href="{{route('home.gallary', 'people')}}">TV series</a></li>
							<li><a href="{{route('home.gallary', 'architecture')}}">Games</a></li>
							<li class="has-children">
